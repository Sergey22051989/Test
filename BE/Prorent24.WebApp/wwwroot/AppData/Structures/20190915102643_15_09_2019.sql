...
CREATE TABLE "sys_migration_database" (
    ...
    "MigrationData" INTEGER NOT NULL,
...
CREATE TABLE "dbo_vehicles" (
    ...
    "LengthUnit" INTEGER NULL,
    "WidthUnit" INTEGER NULL,
    "HeightUnit" INTEGER NULL,
...
CREATE TABLE "dbo_equipments" (
    ...
    "VolumeUnit" INTEGER NULL,
    "PowerUnit" INTEGER NULL,
    ...
    "KitType" INTEGER NOT NULL,
    "Storage" TEXT NULL,
    "PowerConnector" TEXT NULL,
    "SuppliersInfo" TEXT NULL,
...
CREATE TABLE "dbo_vehicle_visibility_crew_members" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_dbo_vehicle_visibility_crew_members" PRIMARY KEY AUTOINCREMENT,
    "CrewMemberId" TEXT NULL,
    "VehicleId" INTEGER NOT NULL,
    CONSTRAINT "FK_dbo_vehicle_visibility_crew_members_AspNetUsers_CrewMemberId" FOREIGN KEY ("CrewMemberId") REFERENCES "AspNetUsers" ("Id") ON DELETE RESTRICT,
...
CREATE TABLE "dbo_task_executor_crew_members" (
...
CREATE INDEX "IX_dbo_task_executor_crew_members_CrewMemberId" ON "dbo_task_executor_crew_members" ("CrewMemberId");

CREATE INDEX "IX_dbo_task_executor_crew_members_TaskId" ON "dbo_task_executor_crew_members" ("TaskId");
...
CREATE INDEX "IX_dbo_user_columns_CreationUserId" ON "dbo_user_columns" ("CreationUserId");

CREATE INDEX "IX_dbo_vehicle_visibility_crew_members_CrewMemberId" ON "dbo_vehicle_visibility_crew_members" ("CrewMemberId");

CREATE INDEX "IX_dbo_vehicle_visibility_crew_members_VehicleId" ON "dbo_vehicle_visibility_crew_members" ("VehicleId");
