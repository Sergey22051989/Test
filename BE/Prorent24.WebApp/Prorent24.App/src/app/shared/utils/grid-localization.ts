  ...
  switch (culture) {
    ...
    default:
      localization = {
        ...
        pagershowrowsstring: "Количество строк:",
        pagerrangestring: " с ",
        ...
        groupsheaderstring:
          "Перетащите столбец и поместите его здесь, чтобы сгруппировать по этому столбцу",
        ...
        filterbooleancomparisonoperators: ["равный", "не равный"],
